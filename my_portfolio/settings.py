...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,my-portfolio-srm4.onrender.com').split(',')
...
LOGIN_REDIRECT_URL = 'portfolio_site:index'
LOGOUT_REDIRECT_URL = 'portfolio_site:index'
LOGIN_URL = 'login'
